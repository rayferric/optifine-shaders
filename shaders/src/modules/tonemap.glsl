...
/**
 * @brief Transforms HDR color to LDR using ACES operator.
...
/**
 * @brief Transforms HDR color to LDR using ACES operator approximation.
...
/**
 * @brief Transforms HDR value to LDR using modified Reinhard
 * operator that mimics ACES curve with infinite white point.
 *
 * @param hdr   HDR value
 * @param ratio positive precision distribution ratio - higher values give more
 * precision to larger HDR values
 *
 * @return LDR value
 */
...
/**
 * @brief Transforms LDR value to HDR using inverse of modified Reinhard
 * operator that mimics ACES curve with infinite white point.
 *
 * @param hdr   LDR value
...
/**
 * @brief Transforms HDR color to LDR using modified Reinhard
 * operator that mimics ACES curve with infinite white point.
 *
 * @param hdr HDR color
 *
...
/**
 * @brief Transforms LDR color to HDR using inverse of modified Reinhard
 * operator that mimics ACES curve with infinite white point.
 *
 * @param hdr LDR color
 *
