...
// }
vec3 computeSSReflection(in sampler2D colorTex, in sampler2D depthTex, in vec3 viewPos, in vec3 normal, in float roughness) {
...
// }
// vec3 computeSSRefraction(in sampler2D colorTex, in sampler2D depthTex, in vec3 viewPos, in vec3 normal, in float roughness, in float ior) {
