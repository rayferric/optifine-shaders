...
const int colortex4Format = RGB8;           // Gamma-Space Sky Light; Gamma-Space Block Light; Material Mask
const int colortex7Format = RGB8;           // Debug Output
const int shadowcolor0Format = RGB8;        // sRGB Shadow Color

const bool colortex0Clear = false;`
const bool colortex1MipmapEnabled = true; // For auto exposure
