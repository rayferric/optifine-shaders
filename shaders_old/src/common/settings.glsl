...
#define BLOOM_INTENSITY 0 // [-2 -1 0 1]
#define EYE_ADAPTATION  0.05 // [0.01 0.05]
...
#define   BLOCK_TEMPERATURE 2300 // [1700 2000 2300 2600 2900]
#define   BLOCK_FALLOFF 4.0 // [4.0 6.0 8.0 12.0 16.0]
#define   SKY_FALLOFF   2.0 // [1.0 2.0 4.0 6.0 8.0 12.0 16.0]
#define   SSAO_SAMPLES 8 // [0 4 8 16]
#define   GLOWING_ORES
