...
#define   MOON_TEMPERATURE      4100  // [3500 3800 4100 4400 4700 10000] // 4100 -> https://physics.stackexchange.com/questions/244922/why-does-moonlight-have-a-lower-color-temperature
#define   TORCH_TEMPERATURE     2300  // [1700 2000 2300 2600 2900]
#define   TORCH_FALLOFF          8.0  // [4.0 6.0 8.0 12.0 16.0]
#define   SKY_FALLOFF            4.0  // [2.0 3.0 4.0 6.0 8.0]
...
const float eyeBrightnessHalflife   =   5.0; // Eye adaptation speed in seconds
...
#define TORCH_ILLUMINANCE       3000.0
#define EMISSION_ILLUMINANCE    1000.0

#define BASE_EXPOSURE   2.0
...
#define MAX_EXPOSURE   -4.0 // Highest exposure value the camera is capable of using
